...
-- Dumping data for table join_table.products: ~7 rows (approximately)
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
INSERT INTO `products` (`id`, `product_name`, `product_brand`, `product_color`, `product_price`, `product_desc`, `product_img`) VALUES
	(1, 'Dark Coffeee', 'Nescafe', '#bc1010', '0', '   Caffeine Rich Drinks', ''),
	(2, 'Butter Biscuits ', 'Parle', '#229fec', '0', '     Creamy Rich Tasty', ''),
	(14, 'red chilly', 'TATA', '#6aca1c', '0', '   TATA TEA', ''),
	(15, 'lifebuoy', '4e4', '#ba2121', '323', ' gfsdf sadf', 'emp-logo.png'),
	(16, 'Mouse', 'DELL', '#2d39e6', '324', '  Mouse', 'about-app-1.jpg'),
	(18, 'Mouse', 'DELL', '#2d39e6', '324', '  Mouse', 'about-app-1.jpg'),
	(19, 'takatak', 'kurkure', '#0fadc2', '10.25', ' Kurkure is very dirty .', 'digital-marketing-2.jpg');
...
-- Dumping data for table join_table.users: ~2 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `email`, `phone`) VALUES
	(1, 'shishir', 'shishir@gmail.com', '9999999999'),
	(2, 'vikas', 'vikas@yahoo.com', '8888888888'),
	(6, 'Hitesh', 'testmail@example.com', '8080808080');
